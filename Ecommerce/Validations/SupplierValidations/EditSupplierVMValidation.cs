...
namespace Ecommerce.Validations.SupplierValidations
{
    public class EditSupplierVMValidation : AbstractValidator<EditSupplierVM>
    {
        public EditSupplierVMValidation()
        {
